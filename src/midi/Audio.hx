...
import openfl._v2.media.SoundChannel;
import haxe.Timer;
...
class Audio
{
	...
	public static var channels = new Map<String, AudioChannel>();
	...
	{
		var tfm = new SoundTransform(mixLevel(mixgroup) * vol, pan);
