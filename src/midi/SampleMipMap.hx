...
class SampleMipMap
{
	...
	private static function _mipup_hermite6(sample : Array<Float>, pow2:Int, rate:Int) : Array<Float>
	{
		var iir = new SVFilter(rate / pow2, 0., rate);
		
		var filtered = new Array<Float>();
		for (s in sample)
	...
	public static function _mip_down_hermite6(sample : Array<Float>, down : Int, rate : Int) : Array<Float>
	{
